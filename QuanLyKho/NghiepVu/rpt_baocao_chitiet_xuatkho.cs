...
{
    public partial class rpt_baocao_chitiet_xuatkho : XtraReport
    {
        public rpt_baocao_chitiet_xuatkho()
        {
            InitializeComponent();
        }
        ...
        public void BindData()
        {
            ...
            col_ngayxuat.DataBindings.Add("Text", DataSource, "ngayxuat").FormatString = "{0:dd/MM/yyyy}";
